\chapter{Testing the hypthesis}\label{sec:testing-the-hypothesis}
...
\begin{figure}[h]
    ...
    \caption[Saliency maps of the model prediction on an image with a ruler.]{Saliency maps of the model prediction on an image with a ruler.
