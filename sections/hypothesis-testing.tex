...
\begin{table}
    ...
    \caption{Model metrics for the two models on the model trained on both full and segmented images,
                ...
                The multiclass F1 score is calculated as a weighted average of the F1 scores of each class.
                The two scores marked \textit{malignant} are scores where the labels has been considered 
                as just benign or malignant (as defined in table \ref{table:ham10000}), and then calculated 
                with benign as the positive class.
    }
\end{table}
