...
By default, the padding in libaries like PyTorch  is $0$ (no padding) as in the example before.
...
\paragraph{Full definition of convolutions definition}\label{sec:convolution_definition}


\subsection{Gradiants of neural networks}
